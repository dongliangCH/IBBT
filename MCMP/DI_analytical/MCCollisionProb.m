...
collisionProb = mcSimulation(MCnum, Ak, Bk, Gk, Ck, DD, LL, xbar, N, PhatPrior0, PtildePrior0, K, world, plot_flag);
...
function collisionProb = mcSimulation(MCnum, Ak, Bk, Gk, Ck, DD, LL, xbar, N, PhatPrior0, PtildePrior0, K, world, plot_flag)
...
for mc = 1:MCnum
    ...
    for k = 1:(N + 1)
        ...
        xhat_MC(:,k) =  xhatPrior_MC(:,k) + LL(:,:,k) * (y_MC - Ck * xhatPrior_MC(:,k));
